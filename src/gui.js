...
IDE_Morph.prototype.aboutSnap = function () {
    ...
    aboutTxt = 'Snaptop ' + SnapVersion + '\nSnap! for Desktop\n\n'
         + 'Copyright \u24B8 2024 Mahdi Ruiz.\n'
         + 'Snaptop is a fork of Snap! But for Desktop.\n\n'

         + 
' Snap! Is Copyright \u24B8 2008-2024 Jens M\u00F6nig and '
        + 'Brian Harvey\n'
    ...
    noticeTxt = localize('License')
        + '\n\nCopyright (C) 2024 Mahdi Ruiz\n'
        + 'Snaptop is free software; you can redistribute it and/or modify it under the terms of the GNU \n'
        ...
        + 'License, or (at your option) any later version. \n\n'
        + 'If you modify this Program, or any covered work, by linking or combining it with Snaptop \n'
        + '(or a modified version of that library), containing parts covered by the terms of GNU General Public License v3.0 or later, \n'
        + 'the licensors of this Program grant you additional permission to convey the \n'
        + 'resulting work. {Corresponding Source for a non-source form of such a combination shall include \n'
        + 'the source code for the parts of Snaptop used as well as that of the covered work.}\n'
